namespace Gestor.Migrations
{
    ...
    public partial class ChangeProdutoToFullSpreadsheet : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey("dbo.Produtoes", "DominioId", "dbo.Dominios", "DominioId", cascadeDelete: false);
            AddForeignKey("dbo.Produtoes", "GrupoRateioId", "dbo.GrupoRateios", "GrupoRateioId", cascadeDelete: false);
            AddForeignKey("dbo.Produtoes", "PcpId", "dbo.Pcps", "PcpId", cascadeDelete: false);
